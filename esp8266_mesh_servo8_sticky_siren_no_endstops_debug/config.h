...
#define TARGET_NODE_ID 3
#endif

// Uncomment to enable connection quality stats on heartbeat logs
...
// Define NO_ENDSTOPS to disable all endstop / limit switch logic and pin initializations
#define NO_ENDSTOPS

#ifndef NO_ENDSTOPS
// Min Limit Switch Pin (Active LOW with internal pull-up, e.g. GPIO 12 / D6)
#define MIN_LIMIT_PIN D8 //set to same pin

// Max Limit Switch Pin (Active LOW with internal pull-up,)
#define MAX_LIMIT_PIN D8
#endif
...
// Siren Audio Output Pin (e.g. GPIO 2 / D4) (D4 must be pull high otherwise chip will not boot)
#define SIREN_PIN D7
...
#define SIREN_STEP_HZ    80    // Frequency step per modulation tick
#define SIREN_TICK_MS    50    // Modulation tick interval in milliseconds
#endif
